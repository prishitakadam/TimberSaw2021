...
public class TimberSawJNI implements Closeable {
    private static final String LIBNAME = "timbersawjni";
    ...
    static {
        ...
        ClassLoader loader = TimberSawJNI.class.getClassLoader();
     ...
     */
    public TimberSawJNI(File file, Options options) {
        if (options == null) {
            options = new Options();
        }
